...
def segment_image(img, max_scale=defaults.CC_SCALE_MAX, min_scale=defaults.CC_SCALE_MIN):
    ...
    binary_average_size = cc.average_size(binary)  #11.401754251
    ...
    cv2.imshow('gaussian_binary',gaussian_binary)
    ...
    suppress_furigana = True #arg.boolean_value('furigana')
    if suppress_furigana:
        ...
        text_only = cleaned2segmented(cleaned, average_size)
        cv2.imshow("text_only2",text_only)
    ''' 
